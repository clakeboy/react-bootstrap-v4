...
```jsx
<GroupStyle size="sm" left="￥" right="元">
    <input type="text" className="form-control" placeholder="输入金额" />
</GroupStyle>
```
...
```jsx
<GroupStyle size="lg" left="￥" right="元">
    <input type="text" className="form-control" placeholder="输入金额" />
</GroupStyle>
```
...
```jsx
<GroupStyle left="￥" right="元" leftClass="text-primary" rightClass="text-success">
    <input type="text" className="form-control" placeholder="输入金额" />
</GroupStyle>
```

### 使用 GroupStyle.Content
...
```jsx
<GroupStyle left={<Button><i className="fa fa-search"></i></Button>} right={<Button>清除</Button>}>
    <input type="text" className="form-control" placeholder="搜索产品..." />
</GroupStyle>
```
...
```jsx
<GroupStyle left="￥" right={<span>元</span>} className="price-group">

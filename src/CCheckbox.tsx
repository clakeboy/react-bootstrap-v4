...
export class CCheckbox extends React.Component<Props,State> {
    ...
    render() {
        return (
            <div {...this.props as any} className={this.getClasses()} style={this.getStyles()} onKeyUp={this.keyUpHandler} onClick={this.changeHandler}>
                <Icon ref={(c:any) => this.icon = c} className='ck-check-icon' icon={this.getCheckedIcon('icon')}
